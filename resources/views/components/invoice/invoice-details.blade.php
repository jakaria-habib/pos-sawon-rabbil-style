                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-8">
                            ...
                            <p class="text-xs mx-0 my-1">User ID: <span id="userId"></span> </p>
                        </div>
                        <div class="col-4">
...
<script>
    ...
    async function invoiceDetails(customer_id, invoice_id){
        ...
        showLoader()
        let res = await axios.post('/invoice-details',{customer_id:customer_id,invoice_id:invoice_id});
        hideLoader()
        ...
        document.getElementById('userId').innerText = res.data['customer']['user_id'];
